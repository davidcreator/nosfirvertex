...
?>
<link rel="stylesheet" href="<?= e(base_url('catalog/view/css/resume-view.css')) ?>">

<section
    class="card resume-linkedin"
    data-theme-accent="<?= e($accentColor) ?>"
    data-theme-header-bg="<?= e($headerBgColor) ?>"
    data-theme-header-text="<?= e($headerTextColor) ?>"
    data-theme-text="<?= e($textColor) ?>"
    data-theme-font-size="<?= (int) $fontSize ?>"
    data-theme-font-family="<?= e($fontBody) ?>"
>
...
<script src="<?= e(base_url('catalog/view/js/resume-view.js')) ?>"></script>
